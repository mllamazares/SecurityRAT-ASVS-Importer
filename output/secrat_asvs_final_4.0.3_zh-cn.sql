...
-- Requirement Skeleton
INSERT INTO `REQUIREMENTSKELETON` VALUES (92,NULL,"V2.8.7","验证生物特征身份验证器仅限于用作次要因素，与“你拥有的东西”和“你知道的东西”一起使用。",92, _binary '',20);
-- Link ASVS Levels
...
-- Requirement Skeleton
INSERT INTO `REQUIREMENTSKELETON` VALUES (96,NULL,"V2.10.1","验证服务内机密不依赖于不变的凭据，例如密码、API 密钥或具有特权访问权限的共享帐户。",96, _binary '',22);
-- Link ASVS Levels
...
-- Requirement Skeleton
INSERT INTO `REQUIREMENTSKELETON` VALUES (97,NULL,"V2.10.2","验证如果服务身份验证需要密码，则使用的服务帐户不是默认凭据（例如，root/root 或 admin/admin 是安装过程中某些服务的默认设置）。",97, _binary '',22);
-- Link ASVS Levels
...
-- Requirement Skeleton
INSERT INTO `REQUIREMENTSKELETON` VALUES (98,NULL,"V2.10.3","验证存储的密码是否有足够的保护，以防止离线恢复攻击，包括本地系统访问。",98, _binary '',22);
-- Link ASVS Levels
...
-- Requirement Skeleton
INSERT INTO `REQUIREMENTSKELETON` VALUES (99,NULL,"V2.10.4","验证密码、与数据库和第三方系统的集成、种子和内部机密以及 API 密钥都得到安全管理，不包含在源代码中或存储在源代码存储库中。 这种存储应能抵御离线攻击。建议使用安全的软件密钥存储（L1）、硬件 TPM 或 HSM（L3）来存储密码。",99, _binary '',22);
-- Link ASVS Levels
